(function () {
  ...
  function update() {
    ...
    root.style.setProperty("--bridge-scale", String(1.02 + sharedHeroScale + frame2.exit * 0.46));
    ...
    root.style.setProperty("--split-left-scale", String(1 + sharedHeroScale + frame2.enter * 0.74));
    ...
    root.style.setProperty("--split-right-scale", String(1 + sharedHeroScale + frame2.enter * 0.74));
    ...
    root.style.setProperty("--frame2-scale", String(1.06 + frame2.enter * 0.08 + frame2.exit * 0.08));
